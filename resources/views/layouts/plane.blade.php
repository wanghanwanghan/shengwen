...
<head>
	...
	<link rel="stylesheet" href="{{asset('public/css/FontAwesome/css/font-awesome.css')}}">
	...
	<link rel="stylesheet" href="{{asset('public/bower_components/AdminLTE/dist/css/AdminLTE.css')}}">
